<x-filament-panels::page>
    ...
    <div class="report-stats-grid cols-3">
        ...
        <div class="report-stat-card">
            ...
            <div>
                <p class="report-stat-label">Total Modal</p>
                <p class="report-stat-value">Rp {{ number_format($stats['total_cost'], 0, ',', '.') }}</p>
            </div>
        </div>
        ...
        <div class="report-stat-card">
            ...
            <div>
                <p class="report-stat-label">Gross Profit</p>
                <p class="report-stat-value">Rp {{ number_format($stats['gross_profit'], 0, ',', '.') }}</p>
            </div>
        </div>
    </div>
